    ...
    <div className="bg-white w-screen relative h-screen flex justify-center items-center">
      ...
      <div className="h-full relative aspect-[9/16] bg-slate-200 px-8 overflow-hidden">
        ...
        <button
          ...
          className="w-16 flex justify-center items-center absolute bottom-8 cursor-pointer aspect-square rounded-full bg-lightBlue"
        >
        ...
        {/* SIDEBAR */}
        <Sidebar isOpen={sidebar} onClick={() => setSidebar(false)} />
      </div>
    </div>
  );
}
